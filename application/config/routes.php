...
$route['update-surat-domisili'] = 'Warga/History/SuratDomisili/update'; // Update Surat Domisili

///surat kematian
$route['history-surat-kematian'] = 'Warga/History/SuratKematian/index';
$route['update-surat-kematian'] = 'Warga/History/SuratKematian/update'; // Update Surat Kematian

//surat tidak mampu
$route['history-surat-tidak-mampu'] = 'Warga/History/SuratTidakMampu/index';
$route['update-surat-tidak-mampu'] = 'Warga/History/SuratTidakMampu/update'; // Update Surat Tidak Mampu

//surat usaha
$route['history-surat-usaha'] = 'Warga/History/SuratUsaha/index';
$route['update-surat-usaha'] = 'Warga/History/SuratUsaha/update'; // Update Surat Usaha

//surat kelahiran
$route['history-surat-kelahiran'] = 'Warga/History/SuratKelahiran/index';
$route['update-surat-kelahiran'] = 'Warga/History/SuratKelahiran/update'; // Update Surat Kelahiran

//surat ket pengnatar
$route['history-surat-keterangan-pengantar'] = 'Warga/History/SuratKeteranganPengantar/index';
$route['update-surat-keterangan-pengantar'] = 'Warga/History/SuratKeteranganPengantar/update'; // Update Surat Keterangan Pengantar
