...
if ($this->session->userdata('role_id') == 3) {
    ...
    $allE = $skd['jumlah'] + $sktm['jumlah'] + $sku['jumlah'] + $skp['jumlah'] + $spak['jumlah'] + $skk['jumlah'];
}
...
<div id="sidebar" class='active'>
    <div class="sidebar-wrapper active">
        <div class="sidebar-header">
            <img src="<?= base_url() ?>./assets/logo/logo_sidebar.png" width="100px" height="120px" class="d-block mx-auto">
        </div>
                ...
                <?php if ($this->session->userdata('role_id') == 1 || $this->session->userdata('role_id') == 2 || $this->session->userdata('role_id') == 3) { ?>
                    <li class="sidebar-item <?= $this->uri->segment(1) == 'dashboard' ? 'active ' : '' ?>">
                        <a href="<?= base_url('dashboard') ?>" class='sidebar-link'>
                            <i class="bi bi-speedometer" style="color: #F7B980;"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                <?php } ?>
                <?php if ($this->session->userdata('role_id') == 1) { ?>
                    ...
                    <li class="sidebar-item  <?= $this->uri->segment(1) == 'data-administrator' ? 'active ' : '' ?>">
                        <a href="<?= base_url('data-administrator') ?>" class='sidebar-link'>
                            <i class="bi bi-person-circle" style="color: #F7B980;"></i>
                ...
                <?php } else if ($this->session->userdata('role_id') == 2) { ?>
                    <li class="sidebar-item  has-sub">
                        <a href="#" class='sidebar-link'>
                            <i class="bi bi-envelope-check-fill" style="color: #F7B980;"></i>
                        ...
                        ?>">
                            <li>
                                <a href="<?= base_url('verifikasi-surat-tidak-mampu') ?>" style="color: white;">Surat Tidak Mampu
                                    <span class="badge badge bg-danger text-white"><?= $Sktm['jumlah'] ?></span></a>
                            </li>
                            <li>
                                <a href="<?= base_url('verifikasi-surat-usaha') ?>" style="color: white;">Surat Usaha
                                    <span class="badge badge bg-danger text-white"><?= $Sku['jumlah'] ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('verifikasi-surat-domisili') ?>" style="color: white;">Surat Domisili
                                    <span class="badge badge bg-danger text-white"><?= $Skd['jumlah'] ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('verifikasi-surat-keterangan-pengantar') ?>" style="color: white;">Keterangan Pengantar
                                    <span class="badge badge bg-danger text-white"><?= $Skp['jumlah'] ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('verifikasi-surat-kelahiran') ?>" style="color: white;">Surat Kelahiran
                                    <span class="badge badge bg-danger text-white"><?= $Spak['jumlah'] ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('verifikasi-surat-kematian') ?>" style="color: white;">Surat Kematian
                ...
                <?php } else if ($this->session->userdata('role_id') == 3) {  ?>
                    <li class="sidebar-item  <?= $this->uri->segment(1) == 'list-surat' ? 'active' : '' ?>">
                        <a href="<?= base_url('list-surat') ?>" class='sidebar-link'>
                            <i class="bi bi-envelope-plus-fill" style="color: #F7B980;"></i>
                    ...
                    <li class="sidebar-item  <?= $this->uri->segment(1) == 'histori-surat' ? 'active' : '' ?>">
                        <a href="<?= base_url('histori-surat') ?>" class='sidebar-link'>
                            <i class="bi bi-clock-history" style="color: #F7B980;"></i>
                            <span>Surat</span>
...
<div id="main">
    <nav class="navbar navbar-header navbar-expand navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <h4 class="nav-title mx-3">Aplikasi Pelayanan Surat</h4>
