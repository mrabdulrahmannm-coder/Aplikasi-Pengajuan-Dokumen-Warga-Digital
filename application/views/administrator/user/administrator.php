                                                ...
                                                foreach ($data as $admin) { ?>
                                                    <tr>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header bg-warning">
                                                                                <strong class="modal-title text-dark" id="exampleModalLabel">Edit Administrator</strong>
                                                                                        ...
                                                                                        <form action="<?= base_url('update-administrator/' . $admin->id) ?>" method="post" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="role_id" class="form-control" id="">
                                                                                                    ...
                                                                                                    <option value="1" <?= $admin->role_id == '1' ? 'selected' : ''  ?>>Admin / RW</option>
                                                                                                    <option value="2" <?= $admin->role_id == '2' ? 'selected' : ''  ?>>Petugas / RT</option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <div class="form-group">
                                                        ...
                                                        <td>
                                                            <?php
                                                            if ($admin->role_id == '1') {
                                                                echo '<span class="badge bg-success">Admin / RW</span>';
                                                            } else if ($admin->role_id == '2') {
                                                                echo '<span class="badge bg-success">Petugas / RT</span>';
                                                            }   
                                                            ?>
                                                        </td>
                                                    </tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-success">
                            <strong class="modal-title text-dark" id="exampleModalLabel">Tambah Administrator</strong>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="<?= base_url('created-administrator') ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="">Nama Lengkap :</label>
                                            <input type="text" name="nama" placeholder="Masukkan Nama Lengkap" class="form-control" id="" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Alamat Email :</label>
                                            <input type="email" name="email" placeholder="Masukkan Email Aktif" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Jenis kelamin :</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="role_id" class="form-control" id="" required>
                                                <option selected disabled>-- PILIH JABATAN --</option>
                                                <option value="1">Admin / RW</option>
                                                <option value="2">Petugas / RT</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="">password :</label>
