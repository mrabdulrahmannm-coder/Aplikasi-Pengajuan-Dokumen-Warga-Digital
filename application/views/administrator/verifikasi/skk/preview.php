            <div class="main-content container-fluid">
            	<div class="page-title">
            		<h4>Preview Surat Keterangan Kematian</h4>
            	</div>
            	<a href="<?= base_url('verifikasi-surat-kematian') ?>" class="btn btn-warning btn-sm mb-2"><i class="bi bi-arrow-left-circle-fill"></i> Kembali</a>
