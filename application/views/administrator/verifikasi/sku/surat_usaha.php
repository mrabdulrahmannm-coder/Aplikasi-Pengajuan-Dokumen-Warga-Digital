<div class="main-content container-fluid">
	<div class="page-title">
		<h4>Verifikasi Surat Keterangan Usaha</h4>
	</div>
								...
								<tbody>
									...
									foreach ($datas as $data) { ?>
										<tr>
											...
											<td>
												<a href="<?= base_url('preview-sku/' . $data->id) ?>"><span
											...
											<td>
												...
												<?php if ($this->session->userdata('role_id') == 2) { ?>
													...
													<?php if ($data->status == 'Menunggu Verifikasi') { ?>
														...
														<div class="btn-group">
															<form action="<?= base_url('update-status-sku') ?>" method="post">
													...
													<?php } else if ($data->status == 'Diterima') { ?>
																...
																<a href="<?= base_url('cetak-surat-usaha/' . $data->id) ?>"
										...
										<div class="modal fade" id="tambahKomentar<?= $data->id ?>" tabindex="-1">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<form action="<?= base_url('komentar-sku/' . $data->id) ?>"
														method="post">
