								...
								<tbody>
									...
									foreach ($datas as $data) { ?>
										<tr>
											...
											<td>
												<a href="<?= base_url('preview-skd/' . $data->id) ?>"><span
											...
											<td>
												...
												<?php if ($this->session->userdata('role_id') == 2) { ?>
													...
													<?php if ($data->status == 'Menunggu Verifikasi') { ?>
														...
														<div class="btn-group">
															<form action="<?= base_url('update-status-skd') ?>" method="post">
													...
													<?php } else if ($data->status == 'Diterima') { ?>
																...
																<a href="<?= base_url('cetak-surat-domisili/' . $data->id) ?>"
										...
										<div class="modal fade" id="tambahKomentar<?= $data->id ?>" tabindex="-1">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<form action="<?= base_url('komentar-skd/' . $data->id) ?>"
														method="post">
