            				...
            				<div class="card">
            					<div class="card-body">
            						<div class="btn-group mb-3">
            							<a href="<?= base_url('data-warga') ?>" class="btn btn-warning btn-sm"><i class="bi bi-arrow-left-circle-fill"></i> Kembali</a>
            						</div>
            						<div class="row">
            							<div class="col-lg-12">
            									...
            									<div class="row">
            										<div class="col-lg-6">
            											<div class="form-group">
            												<label for="">NIK :</label>
            												<input type="number" name="nik" placeholder="Masukkan NIK" class="form-control" value="<?= set_value('nik') ?>">
            											</div>
            										...
            										<div class="col-lg-6">
            											...
            											<div class="form-group">
            												...
            												<input type="text" name="pekerjaan" placeholder="Masukkan Nama Pekerjaan" class="form-control" value="<?= set_value('pekerjaan') ?>">
            											</div>
            											<small class="text-danger"><?= form_error('pekerjaan') ?></small>
            											<div class="form-group">
            												<label for="">Tempat Lahir :</label>
            												<input type="text" name="tempat_lahir" placeholder="Masukkan Tempat Lahir" class="form-control" value="<?= set_value('tempat_lahir') ?>">
            											</div>
            											...
            											<div class="form-group">
            												...
            												<textarea name="alamat" id="" placeholder="Masukkan Alamat Lengkap" class="form-control"><?= set_value('alamat') ?></textarea>
            											</div>
