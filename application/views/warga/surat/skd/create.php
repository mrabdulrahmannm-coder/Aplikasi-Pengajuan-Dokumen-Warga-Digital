            <div class="main-content container-fluid">
                <div class="page-title">
                    <h6><strong>Pengajuan Surat Keterangan Domisili</strong></h6>
                </div>
                                    ...
                                    <form action="<?= base_url('skd/proses') ?>" method="post" enctype="multipart/form-data">
                                        <?php foreach ($data as $d) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="keperluan" id="" cols="30" rows="5" placeholder="Masukkan Tujuan Permohonan Surat" class="form-control" required><?= set_value('keperluan') ?></textarea>
                                            </div>
                                            <div class="form-group">
