            <div class="main-content container-fluid">
                <div class="page-title">
                    <h6><strong>Pengajuan Surat Keterangan Kematian</strong></h6>
                </div>
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('skk/proses') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hubungan" placeholder="Contoh: Istri, Suami, Anak, dll" class="form-control" value="<?= set_value('hubungan') ?>" required>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama_alm" placeholder="Masukkan Nama Alm" class="form-control" value="<?= set_value('nama_alm') ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Bin / Binti :</label>
                                                    <input type="text" name="bin" class="form-control" placeholder="Masukkan Nama Ayah Alm" value="<?= set_value('bin') ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Nik :</label>
                                                    <input type="number" name="nik_a" class="form-control" placeholder="Masukkan NIK" value="<?= set_value('nik') ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tempat_lahir_a" placeholder="Masukkan Tempat Lahir" class="form-control" value="<?= set_value('tempat_lahir') ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class=" form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pekerjaan_a" placeholder="Masukkan Nama Pekerjaan" value="<?= set_value('pekerjaan') ?>" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Alamat :</label>
                                            <textarea name="alamat_a" id="" placeholder="Masukkan Alamat Lengkap" cols="30" rows="5" class="form-control" required><?= set_value('alamat') ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tempat_meninggal" placeholder="Contoh : RS. Harapan Bunda" class="form-control" value="<?= set_value('tempat_meninggal') ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tempat_pemakaman" placeholder="Contoh : TPU Sei Panas" class="form-control" value="<?= set_value('sebab_meninggal') ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Tujuan Permohonan Surat :</label>
                                            <textarea name="keperluan" class="form-control" id="" cols="30" rows="5" placeholder="Masukkan Tujuan Permohonan Surat" required><?= set_value('keperluan') ?></textarea>
                                        </div>
                                        <div class="form-group">
