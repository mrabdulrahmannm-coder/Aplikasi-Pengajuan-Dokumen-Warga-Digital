            <div class="main-content container-fluid">
            	<div class="page-title">
            		<h6><strong>Pengajuan Surat Keterangan Tidak Mampu</strong></h6>
            	</div>
            						...
            						<form action="<?= base_url('sktm/proses') ?>" method="post" enctype="multipart/form-data">
            							<?php foreach ($data as $d) { ?>
            								...
            								<div class="form-group">
            									...
            									<input type="number" name="tanggungan" placeholder="Masukkan Jumlah Menangung Beban Orang" value="<?= set_value('tanggungan') ?>" class="form-control">
            								</div>
            								<div class="form-group">
            									<label for="">Tujuan Permohonan Surat :</label>
            									<small class="text-danger">*Wajib !</small>
            									<textarea name="keperluan" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan Tujuan Permohonan Surat" required><?= set_value('keperluan') ?></textarea>
            								</div>
            								<div class="form-group">
