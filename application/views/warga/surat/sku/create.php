            <div class="main-content container-fluid">
                <div class="page-title">
                    <h6><strong>Pengajuan Surat Keterangan Usaha</strong></h6>
                </div>
                                    ...
                                    <form action="<?= base_url('sku/proses') ?>" method="post" enctype="multipart/form-data">
                                        <?php foreach ($data as $d) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_usaha" placeholder="Masukkan Nama Usaha" value="<?= set_value('nama_usaha') ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Tanggal Mulai / Buka Usaha :</label>
                                                <small class="text-danger">*Wajib !</small>
                                                <input type="date" name="tgl_mulai" value="<?= set_value('tgl_mulai') ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Alamat Usaha :</label>
                                                <small class="text-danger">*Wajib !</small>
                                                <textarea name="alamat_usaha" id="" placeholder="Masukkan Alamat Usaha" cols="30" rows="5" class="form-control" required><?= set_value('alamat') ?></textarea>
                                            </div>
                                            <div class="form-group">
