            <div class="main-content container-fluid">
                <div class="page-title">
                    <h6><strong>Pengajuan Surat Keterangan Pengantar</strong></h6>
                </div>
                                    ...
                                    <form action="<?= base_url('skp/proses') ?>" method="post" enctype="multipart/form-data">
                                        <?php foreach ($data as $d) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="keperluan" id="" placeholder="Masukkan Tujuan Permohonan Surat" cols="30" rows="5" class="form-control" required><?= set_value('keperluan') ?></textarea>
                                            </div>
                                            <div class="form-group">
