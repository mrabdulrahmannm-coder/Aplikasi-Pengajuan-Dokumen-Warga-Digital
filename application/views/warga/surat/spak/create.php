            <div class="main-content container-fluid">
            	<div class="page-title">
            		<h6><strong>Pengajuan Surat Pengantar Akte Kelahiran</strong></h6>
            	</div>
            						...
            						<form action="<?= base_url('spak/proses') ?>" method="post" enctype="multipart/form-data">
            							<?php foreach ($data as $d) { ?>
            								...
            								<div class="form-group">
            									...
            									<input type="text" name="ayah" placeholder="Masukkan Nama Ayah" class="form-control" value="<?= set_value('ayah') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('ayah') ?></small>
            								<div class="form-group">
            									<label for="">Nama Ibu :</label>
            									<input type="text" name="ibu" placeholder="Masukkan Nama Ibu" class="form-control" value="<?= set_value('ibu') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('ibu') ?></small>
            								<div class="form-group">
            									<label for="">Nomor Kartu Keluarga :</label>
            									<input type="number" name="no_kk" placeholder="Masukkan Nomor KK" class="form-control" value="<?= set_value('no_kk') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('no_kk') ?></small>
            								<h6 class="text-center">Data Bayi / Anak</h6>
            								<div class="form-group">
            									<label for="">Nama Bayi :</label>
            									<input type="text" name="nama_bayi" placeholder="Masukkan Nama Bayi" class="form-control" value="<?= set_value('nama_bayi') ?>" required>
            								</div>
            								...
            								<div class="form-group">
            									...
            									<input type="text" name="tempat_lahir_b" placeholder="Masukkan Tempat Lahir" class="form-control" value="<?= set_value('tempat_lahir') ?>" id="" required>
            								</div>
            								...
            								<div class="form-group">
            									...
            									<input type="number" name="anak_ke" placeholder="Contoh : Anak Ke 1, 2, dll" class="form-control" value="<?= set_value('anak_ke') ?>" id="" required>
            								</div>
            								...
            								<div class="form-group">
            									...
            									<textarea name="alamat_b" id="" placeholder="Masukkan Alamat Lengkap" cols="30" rows="5" class="form-control" required><?= set_value('alamat') ?></textarea>
            								</div>
            								<small class="text-danger"><?php form_error('alamat') ?></small>
            								<div class="form-group">
            									<label for="">Tujuan Permohonan Surat :</label>
            									<small class="text-danger">*Wajib !</small>
            									<textarea name="keperluan" id="" cols="30" placeholder="Masukkan Tujuan Permohonan Surat" rows="5" class="form-control" required><?= set_value('keperluan') ?></textarea>
            								</div>
