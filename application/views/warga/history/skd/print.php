    ...
    <div class="container mt-3 page">
        <div class="sub-page">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <center>
                                <strong>
                                    <h5>PEMERINTAH KOTA BATAM</h5>
                                    <h5>KECAMATAN BENGKONG</h5>
            ...
            <div class="text-surat">
                <p>Yang bertanda tangan di bawah ini Kepala Kecamatan Bengkong, Kecamatan Bengkong Kabupaten Kota Batam,
                ...
                <p>Demikian ini menerangkan bahwa benar yang bersangkutan berdomisili
                    di Kecamatan Bengkong, Kabupaten Kota Batam:</p>
                <table class="ms-5">
                    <?php foreach ($data as $d) { ?>
                ...
                <div class="kades float-end">
                    <span class="mb-n2">Bengkong, <?= date('d M Y') ?></span>
                    <p>KEPALA KECAMATAN BENGKONG</p>
