										...
										<tr>
											<div class="modal fade" id="edit<?= $data->id ?>" tabindex="-1"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form action="<?= base_url('update-surat-usaha') ?>" method="post"
															...
															<div class="modal-body">
																...
																<div class="form-group">
																	<label>Tanggal Mulai / Buka Usaha :</label>
																...
																<div class="form-group">
																	...
																	<textarea name="alamat_usaha" class="form-control"
																		rows="2"
																		required><?= $data->alamat_usaha ?></textarea>
																</div>
											...
											<td>
												<?php if ($data->status == 'Diterima') { ?>
													...
													<a href="<?= base_url('cetak-surat-usaha/' . $data->id . '?nomor=' . $data->nomor_surat) ?>"
