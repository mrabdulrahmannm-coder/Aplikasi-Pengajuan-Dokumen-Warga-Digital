<div class="main-content container-fluid">
	<div class="page-title">
		<h4>History Surat Keterangan Pengantar</h4>
	</div>
										...
										<tr>
											<div class="modal fade" id="edit<?= $data->id ?>" tabindex="-1"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form action="<?= base_url('update-surat-keterangan-pengantar') ?>"
											...
											<td>
												<?php if ($data->status == 'Diterima') { ?>
													...
													<a href="<?= base_url('cetak-surat-keterangan-pengantar/' . $data->id . '?nomor=' . $data->nomor_surat) ?>"
