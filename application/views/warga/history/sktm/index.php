<div class="main-content container-fluid">
	<div class="page-title">
		<h4>History Surat Keterangan Tidak Mampu</h4>
	</div>
										...
										<tr>
											<div class="modal fade" id="edit<?= $data->id ?>" tabindex="-1"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form action="<?= base_url('update-surat-tidak-mampu') ?>"
															...
															<div class="modal-body">
																...
																<!-- JUMLAH TANGGUNGAN -->
																<div class="form-group">
																	<label>Menangung Beban Orang :</label>
																	<input type="number" name="tanggungan"
																		class="form-control" min="0"
																		value="<?= isset($data->tanggungan) ? $data->tanggungan : '' ?>"
																		required>
																...
																<div class="form-group">
																	<label>Upload Rumah :</label>
																	<input type="file" name="file_rumah"
																		class="form-control" accept="image/*">
																	<small class="text-muted">
																		Upload foto rumah yang jelas (JPG / PNG)
																	</small>
																</div>
											...
											<td>
												<?php if ($data->status == 'Diterima') { ?>
													...
													<a href="<?= base_url('cetak-surat-tidak-mampu/' . $data->id . '?nomor=' . $data->nomor_surat) ?>"
